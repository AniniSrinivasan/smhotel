...
<html lang="en">
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400" rel="stylesheet"/> <!-- using google fonts -->
    </head>
            ...
            <form id="login-form" autocomplete="on" action="./dashboard.php" method="post">
                <fieldset>
                    <div class="group">
                        ...
                        <input type="text" id="username" name="username" minlength="5" maxlength="15" required placeholder="Enter your username">
                    </div>
                    <div class="group">
