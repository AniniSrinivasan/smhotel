...
PAYMENT_TYPE INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
BOOKING_ID INTEGER NOT NULL,
FOREIGN KEY (BOOKING_ID) REFERENCES BOOKING(BOOKING_ID) ON DELETE CASCADE ON UPDATE CASCADE
FOREIGN KEY (PAYMENT_TYPE) REFERENCES PAYMENT_TYPE(PAYMENT_TYPE) ON DELETE CASCADE ON UPDATE CASCADE
);
